...
import guitesting.model.event.EditableTextEvent_JFC;
import guitesting.model.event.EventModel;
import guitesting.model.event.SelectionEvent_JFC;
 ...
 *
 */
public class Rachota_Select_Item extends EventModel {
  protected String chooseText = "";

  public Rachota_Select_Item(ComponentModel model, String value) {
    super(model);
    setChooseText(value);

  }

  public Rachota_Select_Item(ComponentModel model) {
    super(model);
    if (model != null) {
      ...
      for (String value : targetValues) {
        ...
        children.add(new Rachota_Select_Item(model, value));
        index++;
      }
  ...
  public boolean isSupportedBy(ComponentModel model) {
    ...
    if (component != null)
      return component.getClass().getName().equals("org.cesilko.rachota.gui.DayPlanTable");
    return false;
  }
  ...
  public boolean canConvert(Class clazz) {
    return Rachota_Select_Item.class.equals(clazz);
  }
  ...
  protected void marshalAttributes(EventModel modelEvent, HierarchicalStreamWriter writer) {
    ...
    if (((Rachota_Select_Item) modelEvent).chooseText != null) {
      writer.startNode("chooseText");
      writer.setValue("" + ((Rachota_Select_Item) modelEvent).chooseText);
      writer.endNode();
    }
  ...
  protected void unmarshalAttributes(EventModel event, HierarchicalStreamReader reader) {
    ...
    if (reader.hasMoreChildren()) {
      reader.moveDown();
      ((Rachota_Select_Item) event).chooseText = reader.getValue();
      reader.moveUp();
    }
  }
}
